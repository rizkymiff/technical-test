...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="page-title">Perbarui data transaksi</h3>
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="transaction">Perbarui</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="row">
    <div class="col-lg-6 col-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <form class="form" id="form-data" action="{{ route('admin.transaction.update', $transaction->id) }}" method="post">
                @method('PUT')
                @csrf
                <div class="box-body">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Name </label>
                          <input type="text" class="form-control" placeholder="Nama Barang" required name="item_name" value="{{ $transaction->item_name }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label >Jumlah</label>
                          <input type="number" class="form-control" placeholder="Jumlah Barang" name="qty" required value="{{ $transaction->qty }}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label >Harga</label>
                          <input name="price" type="number" class="form-control" placeholder="Harga barang" required value="{{ $transaction->price }}">
                        </div>
                      </div>
                    </div>
                </div>
